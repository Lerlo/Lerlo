...
<section class="card">
    ...
    <form id="projectEditForm" class="grid-form">
        ...
        @if(($permissions['projects.update_test_doc'] ?? false) === true)
    ...
    @if(($permissions['projects.delete'] ?? false) === true)
...
@push('scripts')
<script>
    window.renderProjectEditPage({{ $projectId }}, {
        canDelete: @json($permissions['projects.delete'] ?? false)
    });
</script>
@endpush
